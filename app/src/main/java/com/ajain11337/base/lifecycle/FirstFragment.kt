...
class FirstFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        Log.d(Constants.LifecycleDebug, "onAttach: $TAG")
    }
    ...
    override fun onCreateView(
        ...
        Log.d(Constants.LifecycleDebug, "onCreateView: $TAG")
        return inflater.inflate(R.layout.fragment_first, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)
        Log.d(Constants.LifecycleDebug, "onViewCreated: $TAG")
    }
    ...
    override fun onDestroyView() {
        super.onDestroyView()
        Log.d(Constants.LifecycleDebug, "onDestroyView: $TAG")
    }
    ...
    override fun onDetach() {
        super.onDetach()
        Log.d(Constants.LifecycleDebug, "onDetach: $TAG")
    }
